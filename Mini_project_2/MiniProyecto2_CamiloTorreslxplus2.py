...
#ax1.xticks(energia2)
ax1.grid()
fig1.savefig("plots/Histogram_N4spins2.png")
...
#ax2.xticks(energia3)
ax2.grid()
fig2.savefig("plots/Histogram_N9spins2.png")
...
#ax2.xticks(energia3)
ax3.grid()
fig3.savefig("plots/Histogram_N16spins2.png")
...
for i in range(len(energia4)):
    print ( "| {:>10}".format(energia5[i]),  "| {:>10}".format(degeneracion5[i]))
print()

standardeviation5 = np.std(den_energias5)
print("La desviación estandar para N=25 es: ",standardeviation5,"\n")
...
ax4.set_title("Ising model for a square of 25 spins", fontsize=18)
#ax2.xticks(energia3)
ax4.grid()
fig4.savefig("plots/Histogram_N25spins2.png")
...
ax11.legend()
ax11.grid()
fig11.savefig("plots/AvarageEnergy2.png")
...
ax22.set_xlim(0,10)
ax22.grid()
fig22.savefig("plots/SpecificHeat2.png")
